				...
				if(roomNum=='1') {
					...
					html += '</a></div><div class="col-md-5"><h3>Deluxe</h3><p>그냥 그냥 디럭스</p>';
						if( ${ sessionScope.id == null} ){
							...
							html += '<a href="confirmForm.to?checkIn='+$( '#checkIn' ).val()+'&checkOut='+$( "#checkOut" ).val()+'&peopleNum='+$("#peopleNum").val()+'&nick='+'${ sessionScope.nick }'+'&roomType=deluxe"><button type="button" class="btn btn-primary">예약하기</button>';
						}
					html += '</a></div></div>';
				} else if(roomNum=='2') {
					...
					html += '<div class="col-md-5"><h3>Grand Deluxe</h3><p>좋은 좋은 디럭스</p>';
						if( ${ sessionScope.id == null} ){
							...
							html += '<a href="confirmForm.to?checkIn='+$( '#checkIn' ).val()+'&checkOut='+$( "#checkOut" ).val()+'&peopleNum='+$("#peopleNum").val()+'&nick='+'${ sessionScope.nick }'+'&roomType=grand"><button type="button" class="btn btn-primary">예약하기</button>';
						}
					html += '</a></div></div>';
				} else if(roomNum=='3') {
					...
					html += '</a></div><div class="col-md-5"><h3>Suite</h3><p>제일 좋은 방</p>';
						if( ${ sessionScope.id == null} ){
							...
							html += '<a href="confirmForm.to?checkIn='+$( '#checkIn' ).val()+'&checkOut='+$( "#checkOut" ).val()+'&peopleNum='+$("#peopleNum").val()+'&nick='+'${ sessionScope.nick }'+'&roomType=suite"><button type="button" class="btn btn-primary">예약하기</button>';
						}
					html += '</a></div></div>';
				}
				html += '<hr>';
