...
<!-- Bootstrap core CSS -->
<link href="/hotel/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
...
<body>
				...
				<ul class="navbar-nav ml-auto">
					...
					<!--  포트폴리오1 -> single portfolio item -->
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href="information/GrandDeluxe.html">Grand
								Deluxe</a> <a class="dropdown-item"
								href="information/SuiteRoom.html">Suite Room</a>
						</div></li>
					<li class="nav-item"><a class="nav-link"
						href="full-width.html">예약</a> <!-- full width --></li>
					<li class="nav-item"><a class="nav-link" href="board.jsp">고객문의</a>
						<!--  포트폴리오1 수정 --></li>
				</ul>
			</div>
		</div>
	...
	<div class="container" height="1000px">
		...
		<h1 class="mt-4 mb-3">
			고객문의 <small>HOTEL TIKKI에 대해 궁금한 점을 물어보세요.</small>
		</h1>
						...
						<c:forEach var="list" items="${ list }">
							...
							<tr height="30">
								<td align="center" width="50"><c:out
										value="${ list.board_num }" /></td>
								<td width="250"><a
									href="content.do?num=${list.board_num }&pageNum=${ currentPage }">
				...
				<ul class="pagination">
					...
					<c:if test="${ count > 0 }">
						...
						<c:if test="${startPage >5 }">
							<li class="page-item">
							<a class="page-link" href="list.do?pageNum=${ startPage-5  }">
							Previous
							</a>
							</li>
						</c:if>
						...
						어느건데
						<c:if test="${ endPage < pageCount }">
							<li class="page-item"><a class="page-link" href="list.do?pageNum=${ startPage+5 }">
							Next
							</a>
							</li>
						</c:if>
